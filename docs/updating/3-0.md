...
sidebar_label: Upgrading to 3.0
...
If you're a plugin author looking to upgrade your plugins to newer Capacitor versions, see the [Upgrade Guide for Capacitor Plugins](../updating/plugins/3-0.md).
...
1. Find the corresponding [plugin documentation](../apis.md), keeping in mind that [some plugins have been split up](#accessibility-app-and-modals-plugins-split-up)
...
![delete public folder](/img/docs/ios/xcode-public-delete-folder.png)
...
![recreate public folder](/img/docs/ios/xcode-public-new-folder.png)
...
1. Read the installation instructions of each plugin [in these docs](../apis.md), looking for permissions that each plugin requires
