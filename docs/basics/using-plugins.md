...
The Capacitor team maintains [a set of Capacitor plugins](../apis.md) for commonly used APIs. There is also a large set of Capacitor plugins available from [the Capacitor Community](https://github.com/capacitor-community/).
