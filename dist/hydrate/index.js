...
class App {
    ...
    render() {
        return (h("site-root", null, h("site-platform-bar", { productName: "Capacitor" }), h("capacitor-site-header", null), h(Router.Switch, null, h(Route, { path: "/" }, h("landing-page", null)), h(Route, { path: "/blog" }, h("blog-page", null)), h(Route, { path: match('/blog/:slug'), render: ({ slug }) => (h("blog-page", { slug: slug })) }), h(Route, { path: "/enterprise" }, h("capacitor-enterprise", null)), h(Route, { path: "/docs" }, h("document-component", { page: "/docs/" })), h(Route, { path: match('/docs/:pageName*'), render: ({ pageName }) => (h("document-component", { page: `/docs/${pageName}` })) }))));
    }
...
const PrismicRichText = (_a) => {
    var { richText, linkResolver, htmlSerializer } = _a, props = __rest$4(_a, ["richText", "linkResolver", "htmlSerializer"]);
...
const blogPageCss = ".sc-blog-page-h{display:block;background:#F5F5F5;padding-top:100px;height:100%}h2.sc-blog-page{margin-top:0}a.sc-blog-page{text-decoration:none}.blog-post.sc-blog-page{margin:0 auto 96px;max-width:830px;padding:96px;background:white;border-radius:4px;-webkit-box-shadow:var(--elevation-2);box-shadow:var(--elevation-2)}.blog-post.sc-blog-page .ui-heading.sc-blog-page{margin:0}.blog-post.sc-blog-page p.sc-blog-page{color:#111}.blog-post__author.sc-blog-page{color:#92A0B3;margin-top:32px;margin-bottom:56px}.blog-post__author.sc-blog-page img.sc-blog-page{display:inline-block;vertical-align:middle;margin-top:-2px;height:28px;border-radius:50%;margin-right:8px}";
...
const getBlogPostUrl = (doc) => `/blog/${doc.uid}`;
...
const getFullContent = (post) => post.data.content.filter(c => c.text !== '<!--more-->');
const BlogPost = ({ post, single = true }) => {
    const content = single ? getFullContent(post) : getContentPreview(post);
    return (h("div", { class: "blog-post" }, h(Heading, { level: 2 }, post.data.title), h(PostAuthor, { author: post.data.author, dateString: post.first_publication_date }), h(PrismicRichText, { richText: post.data.lead }), h(PrismicRichText, { richText: content }), !single && content.length < post.data.content.length ? (h("a", { href: getBlogPostUrl(post) }, "Continue reading")) : null, single && h("disqus-comments", { url: getBlogPostUrl(post), id: post.uid })));
};
const AllPosts = ({ posts }) => posts.docs.map(p => h(BlogPost, { post: p, single: false }));
const PostAuthor = ({ author, dateString }) => {
    const a = author[0];
    const date = parseISO(dateString);
    return (h("div", { class: "blog-post__author" }, h("img", { src: a.author_avatar.url, alt: a.author_name }), h("span", null, "By ", a.author_name, " on ", h(DateTime, { date: date }))));
};
...
class DocumentComponent {
    ...
    render() {
        ...
        return (h("div", { class: "container" }, h("app-burger", null), h("site-menu", { selectedParent: this.parent, siteStructureList: siteStructure }), h("app-marked", { fetchPath: this.item.filePath, renderer: (docsContent) => [
                ...
                h("div", { class: "doc-content" }, h("div", { class: "measure-lg" }, h("div", { onClick: this.handleDocLinkClick, innerHTML: docsContent.content }), h("h2", null, "Contributors"), h("contributor-list", { contributors: docsContent.contributors }), h("lower-content-nav", { next: this.nextItem, prev: this.prevItem }))),
...
const landingPageCss = ".sc-landing-page:root{--color-capacitor-blue:#119EFF;--button-background:var(--color-capacitor-blue);--color-woodsmoke:#16161D;--color-dolphin:#626177;--color-gunpowder:#505061;--color-manatee:#8888A2;--color-cadet-blue:#abb2bf;--color-whisper:#EBEBF7;--color-selago:#F4F4FD;--color-white-lilac:#f8f8fc;--color-white:#fff;--color-green-haze:#00AB47;--color-dodger-blue:#1d9aff;--color-dodger-blue-hover:rgba(#1d9aff, 0.2);--color-old-lace:#fdf5e4;--color-wheatfield:#F1E3C5;--color-pirate-gold:#9A6400;--button-shadow:0 8px 16px rgba(0,0,0,.1), 0 3px 6px rgba(0,0,0,.08);--button-shadow-hover:0 4px 6px rgba(0,0,0,.12), 0 1px 3px rgba(0,0,0,.08);--ease-out-expo:cubic-bezier(0.19, 1, 0.22, 1)}.sc-landing-page-h{display:block}.hero.sc-landing-page{margin-bottom:96px}.hero.sc-landing-page img.sc-landing-page{max-width:100%}.hero__heading.sc-landing-page h1.sc-landing-page{font-size:64px;line-height:100%;letter-spacing:var(--f-tracking-dense);color:var(--c-carbon-100);margin-bottom:16px}.hero__heading.sc-landing-page h3.sc-landing-page{margin-top:12px;margin-bottom:16px;font-size:22px;line-height:160%;letter-spacing:var(--f-tracking-tight);color:#2D4665;font-weight:normal}.hero__buttons.sc-landing-page .ui-button.sc-landing-page{-webkit-box-shadow:0px 1px 2px rgba(2, 8, 20, 0.1);box-shadow:0px 1px 2px rgba(2, 8, 20, 0.1)}.hero__buttons.sc-landing-page .ui-button.sc-landing-page:first-child{margin-right:16px}.hero__buttons.sc-landing-page .btn-white.sc-landing-page{background:white;-webkit-box-shadow:0px 1px 2px rgba(2, 8, 20, 0.1);box-shadow:0px 1px 2px rgba(2, 8, 20, 0.1);color:var(--color-capacitor-blue)}.points.sc-landing-page .ui-paragraph.sc-landing-page{max-width:540px;margin-bottom:64px}.points__img.sc-landing-page{width:64px}.points.sc-landing-page h2.sc-landing-page{margin:0}";
...
class SiteHeader {
    ...
    render() {
        return (h(ResponsiveContainer, { class: "site-header" }, h("a", Object.assign({}, href('/'), { class: "site-header__logo-link" }), h("img", { src: "/assets/img/logo-light.png", alt: "Capacitor Logo" })), h("div", { class: "site-header__menu" }, h("a", Object.assign({}, href('/#features')), "Features"), h("a", Object.assign({}, href('/docs')), "Docs"), h("a", Object.assign({}, href('/community')), "Community"), h("a", Object.assign({}, href('/blog')), "Blog"), h("a", Object.assign({}, href('/enterprise')), "Enterprise")), h("div", { class: "site-header__buttons" }, h(AnchorButton, { href: "https://github.com/ionic-team/capacitor", class: "site-header__buttons__github" }, h("ion-icon", { name: "logo-github" }), this.starCount ? this.starCount : 'GitHub'), h(Button, { class: "site-header__buttons__install" }, "Install"))));
    }
    get el() { return getElement(this); }
