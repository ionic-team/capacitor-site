...
class DocsSearch {
    ...
    render() {
        ...
        return (h(Host, null, h("ion-icon", { icon: "search" }), h("input", { name: "search", type: "search", autocomplete: "off", placeholder: placeholder, "aria-label": placeholder, required: true })));
    }
