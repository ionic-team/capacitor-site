...
const appMenuToggleCss = ":root{--color-capacitor-blue:#119eff;--button-background:var(--color-capacitor-blue);--color-woodsmoke:#16161d;--color-dolphin:#626177;--color-gunpowder:#505061;--color-manatee:#8888a2;--color-cadet-blue:#abb2bf;--color-whisper:#ebebf7;--color-selago:#f4f4fd;--color-white-lilac:#f8f8fc;--color-white:#fff;--color-grey-blue:#73849a;--color-green-haze:#00ab47;--color-dodger-blue:#1d9aff;--color-dodger-blue-hover:rgba(#1d9aff, 0.2);--color-old-lace:#fdf5e4;--color-wheatfield:#f1e3c5;--color-pirate-gold:#9a6400;--button-shadow:0 8px 16px rgba(0,0,0,.1), 0 3px 6px rgba(0,0,0,.08);--button-shadow-hover:0 4px 6px rgba(0,0,0,.12), 0 1px 3px rgba(0,0,0,.08);--ease-out-expo:cubic-bezier(0.19, 1, 0.22, 1)}app-menu-toggle{display:none;position:fixed;top:0px;left:0px;z-index:999}app-menu-toggle .menu-toggle-button{display:-ms-flexbox;display:flex;-ms-flex-align:start;align-items:flex-start;-ms-flex-pack:center;justify-content:center;padding:10px;border:none;background:transparent;font-size:28px;outline:none}app-menu-toggle .menu-toggle-button ion-icon{padding:8px}app-menu-toggle .menu-toggle-button:hover ion-icon{background:rgba(0, 0, 0, 0.03);border-radius:50%}app-menu-toggle .icon-menu{display:block}app-menu-toggle .icon-close{display:none}app-menu-toggle ion-icon{-webkit-transition:opacity 0.3s;transition:opacity 0.3s;opacity:0.7;cursor:pointer}app-menu-toggle.left-sidebar-in>div{height:100vh;padding-right:50px}app-menu-toggle.left-sidebar-in .icon-menu{display:none}app-menu-toggle.left-sidebar-in .icon-close{display:block}@media screen and (max-width: 768px){app-menu-toggle{display:-ms-flexbox;display:flex}}";
...
class AppBurger {
    ...
    render() {
        return (h(Host, null, h("button", { class: "menu-toggle-button", onClick: () => this.handleButtonClick() }, h("ion-icon", { name: "menu-outline", class: "icon-menu" }), h("ion-icon", { name: "close", class: "icon-close" }))));
    }
...
const blogPageCss = "@charset \"UTF-8\";code[class*=language-].sc-blog-post,pre[class*=language-].sc-blog-post{color:white;background:none;text-shadow:0 -0.1em 0.2em black;font-family:Consolas, Monaco, \"Andale Mono\", \"Ubuntu Mono\", monospace;font-size:1em;text-align:left;white-space:pre;word-spacing:normal;word-break:normal;word-wrap:normal;line-height:1.5;-moz-tab-size:4;-o-tab-size:4;tab-size:4;-webkit-hyphens:none;-moz-hyphens:none;-ms-hyphens:none;hyphens:none}@media print{code[class*=language-].sc-blog-post,pre[class*=language-].sc-blog-post{text-shadow:none}}pre[class*=language-].sc-blog-post,.sc-blog-post:not(pre)>code[class*=language-].sc-blog-post{background:hsl(30, 20%, 25%)}pre[class*=language-].sc-blog-post{padding:1em;margin:0.5em 0;overflow:auto;border:0.3em solid hsl(30, 20%, 40%);border-radius:0.5em;-webkit-box-shadow:1px 1px 0.5em black inset;box-shadow:1px 1px 0.5em black inset}.sc-blog-post:not(pre)>code[class*=language-].sc-blog-post{padding:0.15em 0.2em 0.05em;border-radius:0.3em;border:0.13em solid hsl(30, 20%, 40%);-webkit-box-shadow:1px 1px 0.3em -0.1em black inset;box-shadow:1px 1px 0.3em -0.1em black inset;white-space:normal}.token.comment.sc-blog-post,.token.prolog.sc-blog-post,.token.doctype.sc-blog-post,.token.cdata.sc-blog-post{color:hsl(30, 20%, 50%)}.token.punctuation.sc-blog-post{opacity:0.7}.namespace.sc-blog-post{opacity:0.7}.token.property.sc-blog-post,.token.tag.sc-blog-post,.token.boolean.sc-blog-post,.token.number.sc-blog-post,.token.constant.sc-blog-post,.token.symbol.sc-blog-post{color:hsl(350, 40%, 70%)}.token.selector.sc-blog-post,.token.attr-name.sc-blog-post,.token.string.sc-blog-post,.token.char.sc-blog-post,.token.builtin.sc-blog-post,.token.inserted.sc-blog-post{color:hsl(75, 70%, 60%)}.token.operator.sc-blog-post,.token.entity.sc-blog-post,.token.url.sc-blog-post,.language-css.sc-blog-post .token.string.sc-blog-post,.style.sc-blog-post .token.string.sc-blog-post,.token.variable.sc-blog-post{color:hsl(40, 90%, 60%)}.token.atrule.sc-blog-post,.token.attr-value.sc-blog-post,.token.keyword.sc-blog-post{color:hsl(350, 40%, 70%)}.token.regex.sc-blog-post,.token.important.sc-blog-post{color:#e90}.token.important.sc-blog-post,.token.bold.sc-blog-post{font-weight:bold}.token.italic.sc-blog-post{font-style:italic}.token.entity.sc-blog-post{cursor:help}.token.deleted.sc-blog-post{color:red}blog-page.sc-blog-post{display:block;background:#F5F5F5;padding-top:100px;height:100%}.ui-heading.sc-blog-post{font-family:var(--f-family-text)}h2.sc-blog-post{margin-top:0}a.sc-blog-post{text-decoration:none}.blog-posts.sc-blog-post{margin:0 auto;padding-bottom:96px;max-width:830px}.blog-posts__heading.sc-blog-post{margin-bottom:32px}.blog-posts__heading.sc-blog-post .ui-heading.sc-blog-post{font-size:28px;font-weight:600}.blog-post.sc-blog-post{color:#445B78;padding:96px;background:white;border-radius:4px;-webkit-box-shadow:var(--elevation-2);box-shadow:var(--elevation-2)}.blog-post.sc-blog-post ion-icon.sc-blog-post{vertical-align:middle}.blog-post.sc-blog-post .ui-heading.sc-blog-post{margin:0}.blog-post.sc-blog-post .ui-heading.sc-blog-post a.sc-blog-post{color:var(--c-carbon-90);text-decoration:none;border-bottom:none}.blog-post.sc-blog-post .ui-heading.sc-blog-post a.sc-blog-post:hover{border-bottom:none}.blog-post.sc-blog-post ul.sc-blog-post{padding-left:16px}.blog-post.sc-blog-post ul.sc-blog-post li.sc-blog-post{list-style:disc;margin-top:6px}.blog-post__wrap.sc-blog-post{margin:0 auto;padding-bottom:96px;max-width:830px}.blog-post__author.sc-blog-post{color:#92A0B3;margin-top:32px;margin-bottom:56px}.blog-post__author.sc-blog-post img.sc-blog-post{display:inline-block;vertical-align:middle;margin-top:-2px;height:28px;border-radius:50%;margin-right:8px}";
...
class SiteMenu {
    ...
    async presentOverlay() {
        console.log('call overlay present');
    }
