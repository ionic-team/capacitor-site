...
class SiteHeader {
    ...
    render() {
        return (h(ResponsiveContainer, { class: "site-header" }, h("a", Object.assign({}, href('/'), { class: "site-header__logo-link" }), state.pageTheme === 'dark' ? (h("img", { src: "/assets/img/heading/logo-white.png", alt: "Capacitor Logo" })) : (h("img", { src: "/assets/img/heading/logo-black.png", alt: "Capacitor Logo" }))), h("div", { class: "site-header__menu" }, h("nav", null, h(NavLink, { path: "/#features" }, "Features"), h(NavLink, { path: "/docs" }, "Docs"), h(NavLink, { path: "/community" }, "Community"), h(NavLink, { path: "/blog" }, "Blog"), h("a", { href: "https://ionicframework.com/native", target: "_blank" }, "Enterprise"))), h("div", { class: "site-header__buttons" }, h(AnchorButton, { href: "https://github.com/ionic-team/capacitor", class: "site-header__buttons__github" }, h("ion-icon", { name: "logo-github" }), this.starCount ? this.starCount : 'GitHub'), h(Button, { class: "site-header__buttons__install" }, "Install"))));
    }
    get el() { return getElement(this); }
