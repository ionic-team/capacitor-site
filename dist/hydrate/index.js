...
class SiteMenu {
    ...
    render() {
        ...
        return (h(Host, { class: {
            ...
            :
                h("a", { href: `https://github.com/ionic-team/capacitor/releases/tag/2.2.1`, rel: "noopener", target: "_blank", class: "menu-header__version-link" }, "v2.2.1")), h("ul", { class: "menu-list" }, this.siteStructureList.map((item, i) => {
