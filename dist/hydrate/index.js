...
function serializeHyperlink(linkResolver, element, children, key, routerLink = false, router = null) {
    ...
    if (routerLink) {
        return h("a", Object.assign({}, propsWithUniqueKey(props, key), href$1(props.href, router)), children);
    }
    else {
...
const PrismicRichText = (_a) => {
    var { richText, linkResolver, htmlSerializer, routerLink, router } = _a, props = __rest$4(_a, ["richText", "linkResolver", "htmlSerializer", "routerLink", "router"]);
    ...
    htmlSerializer);
    return h("div", Object.assign({}, applyProps(props)), serializedChildren);
};
...
class DocsHeader {
    ...
    render() {
        const { template } = this;
        return (h(Host, null, h("docs-search", null), h("div", { class: "docs-header__links" }, h("a", Object.assign({}, href('/docs'), { class: { 'active': template === 'docs' } }), "Docs"), h("a", Object.assign({}, href('/docs/plugins'), { class: { 'active': template === 'plugins' } }), "Plugins"), h("a", Object.assign({}, href('/blog')), "Blog"), h("a", Object.assign({}, href('/community')), "Community")), h("div", { class: "docs-header__link-divider" }), h("div", { class: "docs-header__external-links" }, h("a", { rel: "noopener", target: "_blank", href: "https://twitter.com/capacitorjs", "aria-label": "Twitter" }, h("ion-icon", { name: "logo-twitter" })), h("a", { rel: "noopener", target: "_blank", href: "https://github.com/ionic-team/capacitor", "aria-label": "GitHub" }, h("ion-icon", { name: "logo-github" })))));
    }
...
class DocumentComponent {
    ...
    fetchNewContent(page, oldPage) {
        ...
        state.showTopBar = false;
        const foundData = findItem(this.menuStructure, this.page);
...
class InPageNavigtion {
    ...
    static get cmpMeta() { return {
        ...
        "$listeners$": [[9, "scroll", "function"], [32, "internalAdLoaded", "componentDidRender"], [9, "resize", "updateItemOffsets"]],
        "$lazyBundleIds$": "-",
        "$attrsToReflect$": []
    }; }
}
...
const trackClick = (adId, event) => {
    ...
    setTimeout(() => {
        const link = hrefClimber(event.target);
...
class InternalAd {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.update();
        this.internalAdLoaded = createEvent(this, "internalAdLoaded", 7);
    }
    ...
    render() {
        if (!this.ad || Object.keys(this.ad).length === 0)
            return;
        return (h("div", { class: "internalAd__wrapper" }, h("a", { href: this.ad.ad_url.url, target: this.ad.ad_url.target, onClick: e => trackClick(this.ad.ad_id, e) }, h("picture", null, h("source", { media: "(min-width: 37.5em)", src: this.ad.ad_image.url }), h("source", { src: this.ad.ad_image['1x'].url }), h("img", { src: this.ad.ad_image.url, alt: this.ad.ad_image.alt, height: this.ad.ad_image['1x'].dimensions.height, width: this.ad.ad_image['1x'].dimensions.width }), h("p", null, this.ad.ad_image.alt)), h(PrismicRichText, { richText: this.ad.ad_copy }))));
    }
    ...
    static get cmpMeta() { return {
        ...
        "$listeners$": [[32, "leftSidebarClick", "update"]],
        "$lazyBundleIds$": "-",
        "$attrsToReflect$": []
    }; }
}
...
const Client = (endpoint, req = null) => Prismic$1.client(endpoint, createClientOptions(req, null));
...
const platformBarCss = ".sc-site-platform-bar-h{display:block;background:var(--c-carbon-100)}.platform-bar__container.sc-site-platform-bar{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;height:44px}.platform-bar__logo.sc-site-platform-bar{-ms-flex:1;flex:1}.platform-bar__logo.sc-site-platform-bar svg.sc-site-platform-bar{height:24px;margin:10px 0;vertical-align:middle}.platform-bar__desc.sc-site-platform-bar{-ms-flex:1;flex:1;-ms-flex-line-pack:end;align-content:flex-end;color:#ccc;font-size:var(--f-size-2);line-height:160%;text-align:right;letter-spacing:var(--f-tracking-tight);margin:0 -3px 2px 0}.platform-bar__desc.sc-site-platform-bar strong.sc-site-platform-bar{color:white;font-weight:400}.platform-bar__desc.sc-site-platform-bar a.sc-site-platform-bar{color:white;text-decoration:none}";
...
class SiteHeader {
    ...
    render() {
        return (h(Host, { class: {
            ...
            } }, h(ResponsiveContainer, { class: "site-header" }, h("a", Object.assign({}, href('/'), { class: "site-header__logo-link" }), state.pageTheme === 'dark' ? (h("img", { src: "/assets/img/heading/logo-white.png", alt: "Capacitor Logo" })) : (h("img", { src: "/assets/img/heading/logo-black.png", alt: "Capacitor Logo" }))), h("div", { class: {
                'site-header__menu': true,
                'site-header__menu--hovered': !!this.hovered || !!this.forceHovered
            } }, h("nav", null, h(NavLink, { path: "/#features", hovered: (this.hovered || this.forceHovered) === 'features', onHover: this.setHovered('features'), onExit: this.clearHover }, "Features"), h(NavLink, { path: "/docs", hovered: this.hovered === 'docs', onHover: this.setHovered('docs'), onExit: this.clearHover }, "Docs"), h(NavLink, { path: "/community", hovered: this.hovered === 'community' || this.forceHovered === 'community', onHover: this.setHovered('community'), onExit: this.clearHover }, "Community"), h(NavLink, { path: "/blog", hovered: this.hovered === 'blog', onHover: this.setHovered('blog'), onExit: this.clearHover }, "Blog"), h("a", { href: "https://ionicframework.com/native", target: "_blank", onMouseOver: this.setHovered('enterprise'), onMouseOut: this.clearHover, class: {
                'link--hovered': this.hovered === 'enterprise'
            } }, "Enterprise"))), h("div", { class: "site-header__buttons" }, h(AnchorButton, { href: "https://github.com/ionic-team/capacitor", class: "site-header__buttons__github" }, h("ion-icon", { name: "logo-github" }), this.starCount ? this.starCount : 'GitHub'), h(AnchorButton, { class: "site-header__buttons__install", href: "/docs/getting-started" }, h("svg", { width: "10", height: "13", viewBox: "0 0 10 13", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { d: "M0 12H10M8.75 5.99986L5 9.59995M5 9.59995L1.25 5.99986M5 9.59995L4.99998 0", stroke: "white" })), "Install")))));
    }
    get el() { return getElement(this); }
...
class SiteMenu {
    ...
    render() {
        ...
        return (h(Host, { class: {
            ...
            } }, h("div", { class: "sticky" }, h("div", null, h("div", { class: "menu-header" }, h("app-menu-toggle", { icon: "close" }), h("a", Object.assign({}, href('/'), { class: "menu-header__logo-link" }), state.pageTheme === 'dark' ? (h("img", { src: "/assets/img/heading/logo-white.png", alt: "Capacitor Logo" })) : (h("img", { src: "/assets/img/heading/logo-black.png", alt: "Capacitor Logo" }))), template === 'plugins' ?
            h("a", Object.assign({}, href('/docs/plugins'), { class: "menu-header__docs-link" }), "plugins")
            : h("a", Object.assign({}, href('/docs'), { class: "menu-header__docs-link" }), "docs"), template === 'docs' && version ?
