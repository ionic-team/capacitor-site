...
class SiteHeader {
    ...
    render() {
        return (h(Host, { class: {
            ...
            } }, h("nav", null, h(NavLink, { path: "/#features", hovered: (this.hovered || this.forceHovered) === 'features', onHover: this.setHovered('features'), onExit: this.clearHover }, "Features"), h(NavLink, { path: "/docs", hovered: this.hovered === 'docs', onHover: this.setHovered('docs'), onExit: this.clearHover }, "Docs"), h(NavLink, { path: "/docs/plugins", hovered: this.hovered === '/docs/plugins', onHover: this.setHovered('/docs/plugins'), onExit: this.clearHover }, "Plugins"), h(NavLink, { path: "/community", hovered: this.hovered === 'community' || this.forceHovered === 'community', onHover: this.setHovered('community'), onExit: this.clearHover }, "Community"), h(NavLink, { path: "/blog", hovered: this.hovered === 'blog', onHover: this.setHovered('blog'), onExit: this.clearHover }, "Blog"), h("a", { href: "https://ionicframework.com/native", target: "_blank", onMouseOver: this.setHovered('enterprise'), onMouseOut: this.clearHover, class: {
