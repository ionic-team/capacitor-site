...
const DocsStylesMixin = `
//Styles for docs article content
  ...
  .paragraph-intro {
    ...
    letter-spacing: var(--p2-tracking);
    font-weight: var(--p2-weight);
    color: var(--p2-color);
    text-transform: var(--p2-transform);
  }

  .paragraph-intro code {
    font-size: 18px;
  }
  ...
  //Top level styles vs. all styles
  > .ui-heading-1 {
