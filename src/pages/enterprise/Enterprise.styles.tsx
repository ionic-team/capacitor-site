...
const EnterpriseStyles = styled.div`
  //#region -------------------------------- VARIABLES ---------------------------------------
  ...
  #top {
    ...
    .heading-group {
      ...
      .cta-row {
        ...
        .ui-button {
          --c-background: var(--c-cyan-90);
          --c-focus: rgba(255, 255, 255, 0.8);
          --c-background--hover: #3daeff;
          --c-background--active: #0a99ff;
        }
  ...
  #companies {
    ...
    .logos {
      ...
      .row1 {
        margin-inline-end: calc((100% - 317px) / 7);
  ...
  #features {
    --h2-color: #b4bcc6;
    --h4-color: #fff;
    --p2-color: var(--c-indigo-40);
    --p3-color: var(--c-indigo-40);
    ...
    ul {
      ...
      padding-inline-start: clamp(4rem, 10vw, 7rem);
      ...
      li {
        ...
        .image-wrapper {
          &::before {
            ...
            display: block;
            position: absolute;
            background-image: url("data:image/svg+xml;base64,");
            height: 100%;
            width: 2px;
            top: 0;
