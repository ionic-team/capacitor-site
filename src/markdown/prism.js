...
(function (Prism) {
  Prism.languages.php = {
    ...
    keyword: [
      ...
      {
        pattern:
          /([(,?]\s*)\b(?:bool|boolean|int|integer|float|string|object|array(?!\s*\()|mixed|self|static|callable|iterable)\b(?=\s*\$)/i,
        alias: 'type-hint',
        greedy: true,
        lookbehind: true,
      },
      {
        pattern:
          /(\)\s*:\s*\?*\s*)\b(?:bool|boolean|int|integer|float|string|object|void|array(?!\s*\()|mixed|self|static|callable|iterable)\b/i,
        alias: 'return-type',
        greedy: true,
        lookbehind: true,
      },
