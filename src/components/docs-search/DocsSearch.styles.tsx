...
const DocsSearchStyles = styled.div`
  ...
  border: 1px solid var(--c-indigo-30);
  border-radius: var(--radius-2);

  transition: border 0.2s ease-out;

  &:hover {
    border: 1px solid var(--c-indigo-50);

    .search-icon path {
      fill: var(--c-indigo-60);
    }
  }
  ...
  &:focus-within {
    ...
    .search-icon path {
      fill: var(--c-indigo-80);
    }
  }

  // #region ------------------------ DARK THEME ---------------------------
  &.theme--dark {
    border: 1px solid var(--c-carbon-70);

    &:hover {
      border: 1px solid var(--c-carbon-50);

      .search-icon path {
        fill: var(--c-carbon-30);
      }
    }
  ...
  .algolia-autocomplete[class^="algolia-autocomplete"] {
    flex: 1;
    ...
    .ds-dropdown-menu {
      ...
      .algolia-docsearch-suggestion {
        ...
        &--text {
          ...
          .algolia-docsearch-suggestion--highlight {
            box-shadow: 0 3px 0 0 rgba(29, 154, 255, 0.3);
          }
        }
      }
    }
  ...
  @media screen and (max-width: $breakpoint-md) {
    .algolia-autocomplete[class^="algolia-autocomplete"] {
      .ds-dropdown-menu {
        .ds-suggestions {
          border-inline-start: 14px solid #fff;
          border-inline-end: 12px solid #fff;
          border-block-start: 24px solid #fff;
        }
        ...
        .algolia-docsearch-suggestion {
          ...
          &--subcategory-column {
            ...
            padding: 0;
            height: auto;
            border-inline-end: 1px solid var(--c-indigo-50);
          }
...
export default DocsSearchStyles;
