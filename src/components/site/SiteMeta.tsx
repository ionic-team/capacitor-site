...
const SiteMeta: React.FC<Props> = ({
  ...
  const defaultDescription = 'Build iOS, Android, Desktop, and Progressive Web Apps with HTML, CSS, and JavaScript.';
  ...
  return (
    <Head>
      ...
      <meta key="twitter-creator" name="twitter:creator" content="ionicframework" />
      <meta key="twitter-title" name="twitter:title" content={fullTitle} />
      <meta key="twitter-description" name="twitter:description" content={description} />

      <meta key="twitter-image" name="twitter:image" content={metaImage || defaultMetaImage} />
      ...
      <meta key="og-image" property="og:image" content={metaImage || defaultMetaImage} />
