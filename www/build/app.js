...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "App","app",0,"app.core.js","es5-build-disabled.js","hydrated","anchor-link,app-burger,app-icon,app-marked,avc-code-type,capacitor-enterprise,capacitor-site,context-consumer,contributor-list,demos-page,doc-snippet,document-component,in-page-navigation,landing-page,lower-content-nav,newsletter-signup,plugin-api,plugin-platforms,site-header,site-menu,stencil-route,stencil-route-link,stencil-route-switch,stencil-route-title,stencil-router",HTMLElement.prototype);