...
- @capacitor/local-notifications (work-in-progress, see [#94](https://github.com/ionic-team/capacitor-plugins/pull/94))
...
- @capacitor/push-notifications (work-in-progress, see [#126](https://github.com/ionic-team/capacitor-plugins/pull/126))
