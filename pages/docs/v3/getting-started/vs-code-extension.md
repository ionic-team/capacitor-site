...
![Video of adding Capacitor](/assets/img/docs/getting-started/integrate-capacitor.gif)
...
![Capacitor Native Configuration Example Image](/assets/img/docs/getting-started/capacitor-vscode-config.gif)
...
![Capacitor Debugging Example Image](/assets/img/docs/getting-started/ionic-vs-code-debugging.jpg)
