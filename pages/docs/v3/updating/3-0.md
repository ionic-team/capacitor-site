...
Because official plugins are now packaged separately, there may be several permissions you can remove from your app's `AndroidManifest.xml`. The following permissions are safe to remove:
