...
A new `androidxActivityVersion` variable is available, add it with value `1.2.0-rc01`.
...
A new `androidxFragmentVersion` variable is available, add it with value `1.3.0-rc01`.
